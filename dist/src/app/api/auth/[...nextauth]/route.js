...
var upstash_redis_adapter_1 = require("@next-auth/upstash-redis-adapter");
var google_1 = __importDefault(require("next-auth/providers/google"));
var handler = (0, next_auth_1.default)({
    // Configure one or more authentication providers
    adapter: (0, upstash_redis_adapter_1.UpstashRedisAdapter)(db_1.db),
    session: {
        strategy: "jwt",
    },
    pages: {
        ...
        jwt: function (_a) {
            return __awaiter(this, arguments, void 0, function (_b) {
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0: return [4 /*yield*/, db_1.db.get("user:".concat(token.id))];
                        case 1:
                            dbUser = (_c.sent());
                            if (!dbUser) {
                                token.id = user.id;
